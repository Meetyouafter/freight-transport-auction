...
/** `BetItem` — a single bet placed in an auction. */
...
/** `BetListResponse` — response of `GET /auctions/{auctionUuid}/bets`. */
...
/** `SetBetRequest` — body of `POST /auctions/{auctionUuid}/bets`. */
